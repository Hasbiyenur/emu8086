...
msg  db "Y",129,"kleniyor...",0Dh,0Ah, 0 
     
err  db "sekt",148,"r: 2, silindir: 0, kafa: 0'da ge",135,"ersiz veriler - b",129,"t",129,"nl",129,"k kontrol",129," ba",159,"ar",141,"s",141,"z oldu.", 0Dh,0Ah
     db "",153,"",167,"retici 11'e bak",141,"n - kendi i",159,"letim sisteminizi olu",159,"turma", 0Dh,0Ah
